...
**[Blog App]** is an application that allows users to create blogs.
...
Clone this repository to your desired folder:
  ```sh
    https://github.com/mohammadnewton/blog_app.git
  ```
...
Feel free to check the [issues page](https://github.com/mohammadnewton/blog_app/issues).
